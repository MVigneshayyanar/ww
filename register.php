...
<br>
      <div class="form-group">
       ...
       <input type="text" class="form-control" placeholder="Enter Last Name" class="form-control" id ="lastName" name="lastName" required/>
     </div>
...
<br>
 <div class="form-group">
   ...
   <div class="form-group">
       ...
       <input type="number" class="form-control" placeholder="phone number" id="number" name="number" required >
       </div>
